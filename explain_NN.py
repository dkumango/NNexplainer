...
##
    ...
    # plot the contribution of each feature (interactive) ####################################
    def plot_contribution_interactive_R(self, input_org):
        ...
        # The 'hbar' variable is used for modifying the line later
    ...
    def plot_feature_importance_R(self, X_data, y_data):
        # baseline mae
